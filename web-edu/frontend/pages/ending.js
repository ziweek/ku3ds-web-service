...
import ImgGuguVr from "../public/images/gugu_vr.png";
import Canvas from "../components/ending/canvas";
...
export default function Main() {
  ...
  useEffect(() => {
    // if (IsVisible == false) {
    //   setTimeout(async () => {
    //     await router.push("https://forms.gle/CGNNjsVsT1wjRZah6", undefined, {
    //       shallow: true,
    //     });
    //   }, 5000);
    // }
          ...
          <div className="absolute z-10 flex items-center justify-center">
            ...
            >
              <motion.div
                ...
                transition={{}}
              >
                <Image src={ImgGuguVr} alt="title" priority height={600} />
              </motion.div>
            </motion.div>
            {/* </button> */}
          </div>
